...
kubectl create secret generic database-credentials -n exercise-03 \
...
kubectl create secret generic wp-credentials -n exercise-03 \
...
kubectl create secret tls wp-sslcerts --namespace="exercise-03" --key key/wp/tls.key --cert key/wp/tls.crt
