...
## Create namespace 's02-exercise-02'
kubectl create ns s02-exercise-02

## Use it as default in the context
kubectl config set-context $(kubectl config current-context) --namespace=s02-exercise-02
...
kubectl create -f ./resources/mariadbdump-cron
kubectl create -f ./resources/wordpress


# Remove everything created
# kubectl delete ns s02-exercise-02